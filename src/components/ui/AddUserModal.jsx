...
const AddUserModal = ({ isOpen, onClose, onAdd }) => {
  ...
  // Schema bhi translate karna padega
              ...
              >
                <Form className="space-y-5">
                  ...
                  <div className="flex flex-col sm:flex-row justify-end gap-3 pt-4">
                    ...
                    <button
                      type="submit"
                      className="w-full sm:w-auto px-5 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium transition-colors shadow-lg shadow-blue-500/30"
                    >
                      {t('Add User')}
                    </button>
                  </div>
